function(project_basic_paramters target_project)
    ...
    if("${CMAKE_SYSTEM_NAME}" STREQUAL "Emscripten")
        ...
        if("${ARGUMENT_PROJECT_TYPE}" STREQUAL "base")
            ...
            # set_target_properties(${target_project} PROPERTIES POSITION_INDEPENDENT_CODE ON)
            # target_compile_options(${target_project} PRIVATE "-fPIC")
        ...
        elseif("${ARGUMENT_PROJECT_TYPE}" STREQUAL "shared_library")
            ...
            # set_target_properties(${target_project} PROPERTIES POSITION_INDEPENDENT_CODE ON)
            # target_compile_options(${target_project} PRIVATE "-fPIC")
            target_link_options(${target_project} PRIVATE "-sSIDE_MODULE=1")
            set_target_properties(${target_project} PROPERTIES PREFIX "" SUFFIX ".wasm")
            add_library(${DEFAULT_ALIAS_NAME} ALIAS ${target_project})
